...
3. 작업 데이터를 입력하고 목록을 조회하는 코드를 메서드로 분리<br>

### **3. 실습**<br>
1. 회원 데이터를 입력하는 코드를 메서드로 분리<br>
2. 회원 데이터 목록을 출력하는 코드를 메서드로 분리<br>
<br>
3. 프로젝트 데이터를 입력하는 코드를 메서드로 분리<br>
4. 프로젝트 데이터 목록을 출력하는 코드를 메서드로 분리<br>
<br>
5. 작업 데이터를 입력하는 코드를 메서드로 분리<br>
6. 작업 데이터 목록을 출력하는 코드를 메서드로 분리<br>
