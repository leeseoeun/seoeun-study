...
public class ProjectHandler {
  ...
  public void add() {
    ...
    project.members = memberHandler.promptMembers();
  ...
  public void update() {
    ...
    String owner = memberHandler.promptOwner(String.format("만든이(%s)? ", project.owner));
    if (owner == null) {
      System.out.println("프로젝트 등록을 취소합니다.");
      return;
    }

    String members = memberHandler.promptMembers(project.members);
