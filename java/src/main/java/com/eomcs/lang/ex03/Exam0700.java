...
public class Exam0700 {
  public static void main(String[] args) {
    ...
    System.out.println("Hello,\b\b\bworld!"); // 커서를 뒤로 한 칸 이동시키는 문자 *\b: 백 스페이스
    System.out.println("Hello,\tworld!"); // 탭 공간을 추가시키는 문자
    System.out.println("Hello,\fworld!"); //    *신경 쓰지 말기
    System.out.println("Hello,\"w\"orld!"); // " 문자를 출력시키는 문자 *"를 쓸 수 있음
